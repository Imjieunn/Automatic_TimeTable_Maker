...
- 순위 : 과목의 선호도 순위를 의미한다.<br>
         '필수'과목 등 이번 학기에 '무조건' 듣고자 하는 과목의 경우 **1순위** 에 해당하며, 관심이 있고 듣고 싶은 과목은 **2순위** , 들었으면 좋겠지만 꼭 듣지 않아도 되는 수업은 **3순위** 로 지정한다. 이외에도 1,2,3 순위에 대한 기준은 이 프로그램을 사용하는 사용자의 주관적인 기준에 따라 나누면 된다.<br><br>
...
사용자의 입력에 따른 최적의 과목 조합을 보여준다. 출력되는 과목 순서는 수강신청날에 '가장 먼저 클릭해야 할 과목 순' 이다.<br>
